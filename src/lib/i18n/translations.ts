...
export const translations = {
  fr: {
    ...
    dashboard: {
      ...
      suggestionsDescription: 'Recommandations IA pour booster votre productivité',
      ...
      suggestionsActionScheduleMeeting: 'Planifier réunion',
    ...
    messages: {
      ...
      shareUpdate: '📋 Partagez une mise à jour',
    ...
    members: {
      ...
      sortRole: 'Rôle',
      sortStatus: 'Statut',
      sortJoinDate: 'Date d\'inscription',
      profile: 'Profil',
    ...
    teams: {
      ...
      noActivityYet: 'Aucune activité récente',
    ...
    reports: {
      ...
      exportWorkload: 'Charge de travail',
    ...
    automations: {
      ...
      sendDeadlineRemindersDesc: 'Envoyer un rappel à l\'assigné 24h avant l\'échéance',
      moveCompletedToDone: 'Déplacer les terminées vers Done',
      moveCompletedToDoneDesc: 'Déplacer automatiquement les tâches terminées vers la colonne Done',
      ...
      weeklyProgressReport: 'Rapport de progression hebdomadaire',
      weeklyProgressReportDesc: 'Générer et partager un rapport chaque semaine',
      autoCreateRecurringTasks: 'Créer des tâches récurrentes',
      autoCreateRecurringTasksDesc: 'Créer automatiquement des tâches récurrentes selon un planning',
    ...
    progressBoard: {
      ...
      subtitle: 'Suivez l\'avancement de vos projets et de votre équipe',
      totalProjects: 'Projets actifs',
      avgCompletion: 'Complétion moyenne',
      tasksThisWeek: 'Tâches cette semaine',
      onTimeRate: 'Respect des délais',
      projectProgress: 'Avancement des projets',
      todo: 'À faire',
      inProgress: 'En cours',
      review: 'En revue',
      ...
      velocitySubtitle: 'Tâches terminées cette semaine',
      tasksCompleted: 'Terminées',
      milestones: 'Jalons à venir',
      milestonesSubtitle: 'Prochaines étapes clés',
      completed: 'Terminé',
    },
  ...
  en: {
    ...
    dashboard: {
      ...
      suggestionsDescription: 'AI-powered recommendations to boost your productivity',
      ...
      suggestionsActionScheduleMeeting: 'Schedule Meeting',
    ...
    automations: {
      ...
      sendDeadlineRemindersDesc: 'Send a reminder to the assignee 24h before the deadline',
      moveCompletedToDone: 'Move completed to Done',
      moveCompletedToDoneDesc: 'Automatically move completed tasks to the Done column',
      ...
      weeklyProgressReportDesc: 'Generate and share a progress report every week',
      autoCreateRecurringTasks: 'Auto-create recurring tasks',
      autoCreateRecurringTasksDesc: 'Automatically create recurring tasks on a schedule',
    ...
    progressBoard: {
      ...
      velocitySubtitle: 'Tasks completed this week',
      tasksCompleted: 'Completed',
      milestones: 'Upcoming Milestones',
      milestonesSubtitle: 'Key upcoming milestones',
      completed: 'Completed',
    },
